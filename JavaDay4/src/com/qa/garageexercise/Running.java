...
public class Running {
	...
	public static void main(String[] args) {
		...
		((Car) car).changeWheels(); // prints the changewheels method from the car class
		((Motorbike) mb).changeWheels(); // prints the changewheels method from the motorbike class
		((Caravan) caravan).changeWheels(); // prints the changewheels method from the caravan class
